...
public final class PersonServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.stub.person.v1.PersonService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.stub.person.v1.PersonRequest,
      com.stub.person.v1.PersonResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = com.stub.person.v1.PersonRequest.class,
      responseType = com.stub.person.v1.PersonResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.stub.person.v1.PersonRequest,
      com.stub.person.v1.PersonResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.stub.person.v1.PersonRequest, com.stub.person.v1.PersonResponse> getCreateMethod;
      ...
      synchronized (PersonServiceGrpc.class) {
        if ((getCreateMethod = PersonServiceGrpc.getCreateMethod) == null) {
          PersonServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<com.stub.person.v1.PersonRequest, com.stub.person.v1.PersonResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stub.person.v1.PersonRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stub.person.v1.PersonResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.stub.person.v1.PersonRequestCode,
      com.stub.person.v1.PersonResponse> getFindMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "find",
      requestType = com.stub.person.v1.PersonRequestCode.class,
      responseType = com.stub.person.v1.PersonResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.stub.person.v1.PersonRequestCode,
      com.stub.person.v1.PersonResponse> getFindMethod() {
    io.grpc.MethodDescriptor<com.stub.person.v1.PersonRequestCode, com.stub.person.v1.PersonResponse> getFindMethod;
    if ((getFindMethod = PersonServiceGrpc.getFindMethod) == null) {
      synchronized (PersonServiceGrpc.class) {
        if ((getFindMethod = PersonServiceGrpc.getFindMethod) == null) {
          PersonServiceGrpc.getFindMethod = getFindMethod =
              io.grpc.MethodDescriptor.<com.stub.person.v1.PersonRequestCode, com.stub.person.v1.PersonResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "find"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stub.person.v1.PersonRequestCode.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stub.person.v1.PersonResponse.getDefaultInstance()))
  ...
  public static abstract class PersonServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void create(com.stub.person.v1.PersonRequest request,
        io.grpc.stub.StreamObserver<com.stub.person.v1.PersonResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateMethod(), responseObserver);
    }

    /**
     */
    public void find(com.stub.person.v1.PersonRequestCode request,
        io.grpc.stub.StreamObserver<com.stub.person.v1.PersonResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.stub.person.v1.PersonRequest,
                com.stub.person.v1.PersonResponse>(
                  this, METHODID_CREATE)))
          .addMethod(
            getFindMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.stub.person.v1.PersonRequestCode,
                com.stub.person.v1.PersonResponse>(
                  this, METHODID_FIND)))
          .build();
    }
  ...
  public static final class PersonServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PersonServiceBlockingStub> {
    ...
    /**
     */
    public com.stub.person.v1.PersonResponse create(com.stub.person.v1.PersonRequest request) {
    ...
    /**
     */
    public com.stub.person.v1.PersonResponse find(com.stub.person.v1.PersonRequestCode request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PersonServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PersonServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.stub.person.v1.PersonResponse> create(
        com.stub.person.v1.PersonRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.stub.person.v1.PersonResponse> find(
        com.stub.person.v1.PersonRequestCode request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE:
          serviceImpl.create((com.stub.person.v1.PersonRequest) request,
              (io.grpc.stub.StreamObserver<com.stub.person.v1.PersonResponse>) responseObserver);
          break;
        case METHODID_FIND:
          serviceImpl.find((com.stub.person.v1.PersonRequestCode) request,
              (io.grpc.stub.StreamObserver<com.stub.person.v1.PersonResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PersonServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.stub.person.v1.Person.getDescriptor();
    }
